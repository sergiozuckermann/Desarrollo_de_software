...
// Define the AverageInteractionTime functional component
const AverageInteractionTime = () => {
    ...
    useEffect(() => {
      ...
      const fetchData = async () => {
        try {
          // Call the GetPerformanceMetrics function from the userService and pass the string "AIT" as an argument
      ...
      <div className="w-full p-4 sm:p-6 lg:p-8 card overflow-hidden bg-[#F8F9FA] dark:bg-primary">
        ...
        <div className="max-w-xl mx-auto">
          ...
          <h1 className="text-5xl md:text-6xl lg:text-6xl xl:text-6xl font-roboto mb-8 dark:text-white">
            {/* Heading with responsive font sizes, font family, and white text color in dark mode */}
            Average Interaction Time
          </h1>
          <div
            className="rounded-lg p-2 overflow-y-auto mt-4 pb-16"
            style={{
...
// Export the AverageInteractionTime component as the default export
