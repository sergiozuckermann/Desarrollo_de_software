...
const WorkerCard: React.FC<WorkerCardProps> = ({ imageURL, name, position, experience, points, status }) => {
  ...
  return (
    <div>
      {/* Large Device Layout */}
      <div className="hidden h-[65%] max-w-sm p-4 overflow-hidden border-2 border-gray-400 shadow-lg rounded-xl md:block bg-tertiary dark:bg-gray-900">
        ...
        <div className="items-center px-6 py-4 text-center">
          ...
          <div className="flex flex-col"> 
            <h3 className="text-gray-800 text-[30px] font-roboto mr-4 dark:text-white">Experience Points: </h3> {/* ESTE COMPONENTE TAMBIÉN LO QUIERO RENDERIZADO PARA EL SUPERVISOR, para el agente PONERLO para el supervisor quitarlo*/}
            <div className="flex items-center justify-center w-full pb-9">
              <div className="text-gray-800 text-[60px] font-roboto mr-4 dark:text-gray-400">{points}</div>
