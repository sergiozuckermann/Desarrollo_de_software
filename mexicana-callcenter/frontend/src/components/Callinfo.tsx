    ...
    <div>
      ...
      <div className="hidden h-[65%] max-w-sm p-4 overflow-hidden border-2 border-gray-400 shadow-lg rounded-xl md:block bg-tertiary">
        ...
        <div className="items-center px-6 py-4 text-center">
          ...
          <p className="pb-5 text-base text-gray-700"><strong>{agentposition}</strong></p>
          <p className="pb-5 text-sm text-gray-600"> <strong>Classification: </strong>{callclasification} </p>
          <p className="pb-5 text-base text-gray-600"><strong>Client name: </strong> {clientname}</p>
          <p className="pb-5 text-base text-gray-600"><strong>Priority : </strong>{priority}</p>
          <p className="pb-5 text-base text-gray-600"><strong>Reason: </strong>{reason}</p>
          <p className="pb-5 text-base text-gray-600"><strong>Talk time: </strong>{talktime}</p>
