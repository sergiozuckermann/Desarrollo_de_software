...
interface Metric {
  ...
  percentage: string; // The percentage property is a string
}

// Define the AverageResolutionTime functional component
const AverageResolutionTime = () => {
    ...
    useEffect(() => {
      ...
      const fetchData = async () => {
        try {
          // Call the GetPerformanceMetrics function from the userService and pass the string "ACRT" as an argument
      ...
      <div className="w-full p-4 sm:p-6 lg:p-8 card overflow-hidden bg-[#F8F9FA] dark:bg-primary">
        ...
        <div className="max-w-xl mx-auto">
          ...
          <div
            ...
            style={{
              WebkitOverflowScrolling: 'touch', // Enable smooth scrolling on WebKit-based browsers
              msOverflowStyle: 'none', // Hide scrollbars on Internet Explorer and Edge
              scrollbarWidth: 'none', // Hide scrollbars on Firefox
              maxHeight: '480px', // Set a maximum height of 480 pixels
            }}
          >
            {/* Container with rounded corners, padding, vertical auto-scrolling, overflow hidden, max height, and white text color in dark mode */}
              ...
              <div>
                ...
                {data.map((item, index) => (
                  <div key={index} className="flex justify-between items-center mb-2">
                    {/* Flex container with space between, centered items, and margin-bottom */}
...
// Export the AverageResolutionTime component as the default export
