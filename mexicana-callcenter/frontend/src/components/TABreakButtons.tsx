...
const TABreakButtons: React.FC<TABreakButtonsProps> = ({ picture, title, handleClick }) => {
  return (
    <button className="flex items-center px-12 py-12 space-x-2 font-light transition-colors duration-300 ease-in-out shadow-md bg-[#D9D9D9] font-roboto rounded-3xs text-primary hover:text-white hover:bg-primary " onClick={handleClick} >
